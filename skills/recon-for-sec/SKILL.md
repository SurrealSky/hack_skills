...
- [Insecure Source Code Management](../temp/insecure-source-code-management/SKILL.md) — .git/.svn/.hg exposure detection
- [Dependency Confusion](../temp/dependency-confusion/SKILL.md) — Supply chain reconnaissance for internal package names
