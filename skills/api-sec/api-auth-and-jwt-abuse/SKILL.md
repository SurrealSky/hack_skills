...
- For default credential and brute-force planning: [authentication bypass](../../auth-sec/authbypass-authentication-flaws/SKILL.md)
- For full JWT and OAuth depth: [jwt oauth token attacks](../../auth-sec/jwt-oauth-token-attacks/SKILL.md)
- For OAuth or OIDC configuration flaws in browser and SSO flows: [oauth oidc misconfiguration](../../auth-sec/oauth-oidc-misconfiguration/SKILL.md)
- For credentialed browser reads and origin trust bugs: [cors cross origin misconfiguration](../../auth-sec/cors-cross-origin-misconfiguration/SKILL.md)