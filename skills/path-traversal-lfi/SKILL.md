...
### 7. Upload race
```
# Upload a PHP file via a normal upload endpoint, then include it via LFI
# before server-side validation or deletion completes
# (race the include against the cleanup job)
```
